      ...
      <div key={comment.id} className={`${styles.comment} ${isReply ? styles.reply : ''}`}>
         ...
         <div className={styles.commentActions}>
            <div className={styles.actionButtons}>
               <Button variant="link" className={styles.actionButton} onClick={() => setReplyingTo(comment.id)}>
            ...
            <div className={styles.stats}>
               <span className={styles.likes}>
                  ...
                  <Button
                     variant="link"
                     className={styles.likeButton} // 스타일 일관성을 위해 다른 버튼과 유사한 클래스 추가를 권장합니다.
                     onClick={() => {
                        // thunk 액션에 boardId와 commentId를 모두 전달합니다.
                        dispatch(likeCommentThunk(comment.id))
                     }}
                  >
                     {comment.like_count}
                  </Button>
