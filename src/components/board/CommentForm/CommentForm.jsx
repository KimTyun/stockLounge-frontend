...
import { createCommentThunk, getCommentByIdThunk } from '../../../features/commentSlice'
   ...
   if (!user) {
      return (
         <div className={styles.commentForm}>
            <div className="text-center py-3">로그인 하셔야 댓글 등록을 할 수 있습니다.</div>
         </div>
      )
   }
         ...
         <Form onSubmit={handleSubmit}>
            ...
            <div className={styles.formActions}>
               ...
               <div className={styles.buttons}>
                  {parentId && onCancel && (
                     <Button variant="outline-secondary" size="sm" onClick={onCancel} disabled={loading} className="me-2">
                        취소
                     </Button>
                  )}
                  <Button variant="primary" size="sm" type="submit" disabled={loading || !content.trim()}>
                     {loading ? (
                        <>
