...
const ChartTabs = ({ selectedCoin, onCoinSelect }) => {
   ...
   return (
      <div className={styles.chartTabs}>
         <Tabs activeKey={activeTab} onSelect={(tab) => setActiveTab(tab)} className={styles.tabs}>
                        ...
                        <Col md={6}>
                           <div className={styles.priceSection}>
                              <h3 className={styles.price}>
                                 ...
                                 <span className={`${styles.change} ${coinData.overview.isPositive ? styles.positive : styles.negative}`}>{coinData.overview.change24h}</span>
                              </h3>
                              <p className={`${styles.changeValue} ${coinData.overview.isPositive ? styles.positive : styles.negative}`}>{coinData.overview.changeValue}</p>
                           </div>
                        </Col>
                        <Col md={6}>
                     ...
                     <Row>
                        <Col md={4}>
                           <div className={styles.analysisCard}>
                              ...
                              <div className={styles.confidence}>신뢰도: {coinData.analysis.shortTerm.confidence}%</div>
                              <div className={styles.timeframe}>기간: {coinData.analysis.shortTerm.timeframe}</div>
                              <div className={styles.targets}>
                                 <strong>목표가:</strong>
                                 {coinData.analysis.shortTerm.targets.map((target, index) => (
                                    <span key={index} className={styles.target}>
                                       {target}
                                    </span>
                                 ))}
                              </div>
                        ...
                        <Col md={4}>
                           <div className={styles.analysisCard}>
                              ...
                              <div className={styles.confidence}>신뢰도: {coinData.analysis.mediumTerm.confidence}%</div>
                              <div className={styles.timeframe}>기간: {coinData.analysis.mediumTerm.timeframe}</div>
                              <div className={styles.targets}>
                                 <strong>목표가:</strong>
                        ...
                        <Col md={4}>
                           <div className={styles.analysisCard}>
                              ...
                              <div className={styles.confidence}>신뢰도: {coinData.analysis.longTerm.confidence}%</div>
                              <div className={styles.timeframe}>기간: {coinData.analysis.longTerm.timeframe}</div>
                              <div className={styles.targets}>
                                 <strong>목표가:</strong>
