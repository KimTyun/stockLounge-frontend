          ...
          <Row>
            ...
            <Col md={6}>
              ...
              <Table striped bordered>
                <tbody>
                  <tr>
                    <td><strong>작성 게시글</strong></td>
                    <td>{selectedUser.posts}개</td>
                  </tr>
                  <tr>
                    <td><strong>작성 댓글</strong></td>
                    <td>{selectedUser.comments}개</td>
                  </tr>
                  <tr>
                    <td><strong>보유 포인트</strong></td>
                    <td>{selectedUser.points.toLocaleString()}P</td>
                  </tr>
                  <tr>
                    <td><strong>경고 횟수</strong></td>
                    <td>
                      <span className={selectedUser.warnings > 0 ? 'text-danger' : 'text-success'}>
                        {selectedUser.warnings}회
                      </span>
                    </td>
                  </tr>
                </tbody>
              ...
              {selectedUser.warnings > 0 && (
                <Alert variant="warning">
                  ...
                  이 사용자는 {selectedUser.warnings}회의 경고를 받았습니다.
                </Alert>
              )}
            </Col>
          </Row>
              ...
              <tbody>
                {sortedUsers.map(user => (
                  <tr key={user.id}>
                    ...
                    <td>
                      <span className={user.warnings > 0 ? 'text-danger' : 'text-success'}>
                        {user.warnings}
                      </span>
                    </td>
                    <td>
                      <Button
                        ...
                        size="sm"
                        className={`${styles.actionButton} me-1`}
