            ...
            <Col md={3}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) => handleSettingChange('pointsPerPost', parseInt(e.target.value))}
                  min="0"
                />
              </Form.Group>
            </Col>
            <Col md={3}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) => handleSettingChange('pointsPerComment', parseInt(e.target.value))}
                  min="0"
                />
              </Form.Group>
            </Col>
            <Col md={3}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) => handleSettingChange('pointsPerLike', parseInt(e.target.value))}
                  min="0"
                />
              </Form.Group>
            </Col>
            <Col md={3}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) => handleSettingChange('coinExchangeRate', parseInt(e.target.value))}
                  min="1"
                />
                <Form.Text className="text-muted">
                  {settings.coinExchangeRate}포인트 = 1코인
                </Form.Text>
              </Form.Group>
            </Col>
          </Row>
          ...
          <Row className="mb-4">
            <Col md={8}>
              <Form.Control
                ...
                onKeyPress={(e) => e.key === 'Enter' && handleAddBanWord()}
              />
            </Col>
            <Col md={4}>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <Button
                      ...
                      size="sm"
                      onClick={() => handleRemoveBanWord(word)}
                    >
