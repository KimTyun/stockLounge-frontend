...
const SiteManagement = () => {
   ...
   const { settings, banWords, rewards, loading, error }= useSelector((state)=>state.admin)
...
// 금칙어 삭제
   ...
   return (
        <div>
            ...
            {/* 상태 변경 성공/실패 Alert */}
            {showAlert && <Alert variant={alertType} className="mb-4">{alertMessage}</Alert>}
