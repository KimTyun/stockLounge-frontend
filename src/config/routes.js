...
// 보호된 라우트 (로그인 필요)
export const PROTECTED_ROUTES = [ROUTES.BOARD_WRITE, ROUTES.BOARD_EDIT, ROUTES.USER_INFO, ROUTES.USER_EDIT, ROUTES.USER_POINTS, ROUTES.USER_POINT_EXCHANGE, ROUTES.USER_POINT_HISTORY]

// 관리자 전용 라우트
export const ADMIN_ROUTES = [ROUTES.ADMIN, ROUTES.ADMIN_DASHBOARD, ROUTES.ADMIN_USERS, ROUTES.ADMIN_USERS_DETAIL, ROUTES.ADMIN_BOARDS, ROUTES.ADMIN_BOARDS_DETAIL, ROUTES.ADMIN_STATISTICS, ROUTES.ADMIN_SITE]
